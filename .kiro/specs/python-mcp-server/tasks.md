...
- [-] 1. Set up Python project foundation
...
- [ ] 2. Implement core data models and validation
  - [ ] 2.1 Create Pydantic models for all tool inputs
  ...
  - [ ] 2.2 Create Pydantic models for NPS API responses
...
- [ ] 3. Implement NPS API client with HTTPX
  - [ ] 3.1 Create base API client class
  ...
  - [ ]* 3.3 Write property test for API client behavior
...
- [ ] 8. Implement comprehensive error handling
  ...
  - [ ]* 8.3 Write integration tests for error scenarios
...
- [ ] 9. Integration and final wiring
  ...
  - [ ]* 9.3 Write property test for NPS API integration consistency
